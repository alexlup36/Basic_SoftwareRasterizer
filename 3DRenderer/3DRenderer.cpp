    ...
    *stdin = *hf_in;
	...
	while (1)
	{
		...
		else
		{
			...
			renderer->Update(dt);
			renderer->Draw();
			InvalidateRect(renderer->hwnd, NULL, FALSE);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		{
		case 0x31:
			renderer->displayOption = 1;
			break;
		case 0x32:
			renderer->displayOption = 2;
			break;
		case 0x33:
			renderer->displayOption = 3;
			break;
		case 0x34:
			renderer->displayOption = 4;
			break;
		case 0x35:
			renderer->displayOption = 5;
			break;
		case 0x36:
			renderer->displayOption = 6;
			break;
		case 0x37:
			renderer->displayOption = 7;
			break;
		}
		break;
	case WM_COMMAND:
